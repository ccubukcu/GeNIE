(function($) {
	...
	$('.basic-slider, #single-slider, #sidebar-tweets, .portfolio-slider')
			.flexslider({
				animation : "slide",
				controlNav : false,
				prevText : "",
	...
	$('.accordion-header').first().toggleClass('active-header').toggleClass(
			'inactive-header');
	...
	$('.accordion-header').on(
			...
			function() {
				if ($(this).is('.inactive-header')) {
					$('.active-header').toggleClass('active-header')
							.toggleClass('inactive-header').next()
							.slideToggle().toggleClass('open-content');
					$(this).toggleClass('active-header').toggleClass(
							'inactive-header');
	...
	$('.main-navigation').find('ul:first').clone()
	...
	$('.mobile-navigation').find('.haschild').children('a').one('click',
			function() {
				return false;
			}).on("click", function() {
		return true;
